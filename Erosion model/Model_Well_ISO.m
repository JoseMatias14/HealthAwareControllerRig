...
% DP [mbar]
DPmax = [1.36, 3.20, 4.65, 6.76, 9.77, 13.13, 16.91, 21.56, 26.86;
         0.82, 1.89, 3.53, 5.80, 9.23, 12.59, 16.42, 20.64, 26.40;
         1.17, 2.99, 4.54, 7.42, 9.44, 13.57, 18.26, 22.53, 27.34];

DPmin = [2.33, 4.00, 6.07, 9.13, 13.22, 16.52, 21.66, 26.01, 32.31;
...
rho = 1000;
D = 2; %[cm]
DP_var = Cd*((Q_var/(60*1000))*rho)^2*(1 - (0.3/2)^4)/((pi()/4)^2*2*rho*(0.01*d)^4)/100;
